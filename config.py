...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002276913410"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002276913410"))
...
USER_REPLY_TEXT = os.environ.get("USER_REPLY_TEXT", "ᴅᴏɴ'ᴛ sᴇɴᴅ ᴍᴇ ᴍᴇssᴀɢᴇs ᴅɪʀᴇᴄᴛʟʏ ɪ'ᴍ ᴏɴʟʏ ғɪʟᴇ sʜᴀʀᴇ ʙᴏᴛ! 📌")

#your bot token here from https://telegram.me/BotFather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6950912269:AAH2b4DVR5QClFXbMmuC2TQZAb_QSAG5JB4") 
#your api id from https://my.telegram.org/apps
APP_ID = int(os.environ.get("APP_ID", "21225263"))
#your api hash from https://my.telegram.org/apps
API_HASH = os.environ.get("API_HASH", "7554af47b14a77d8c769cf4c1a202f02")
#your channel_id from https://t.me/MissRose_bot by forwarding dummy message to rose and applying command `/id` in reply to that message
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002254750726"))
#your id of telegram can be found by https://t.me/MissRose_bot with '/id' command
OWNER_ID = int(os.environ.get("OWNER_ID", "7080761497"))
...
#UPI ID
UPI_ID = os.environ.get("UPI_ID", "Pkrmo45@ybl")
#UPI QR CODE IMAGE
...
FORCE_MSG = os.environ.get("FORCE_MSG", "Hello {first}\n\n<b>**🕵️ Jᴏɪɴ Tʜᴇ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Tᴏ Gᴇᴛ Fɪʟᴇ\n\n👨‍💻 Fɪʀsᴛ  Cʟɪᴄᴋ Oɴ Jᴏɪɴ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Bᴜᴛᴛᴏɴ, Tʜᴇɴ Jᴏɪɴ Cʜᴀɴɴᴇʟ Aғᴛᴇʀ Cʟɪᴄᴋ Oɴ Tʀʏ Aɢᴀɪɴ Bᴜᴛᴛᴏɴ**</b> 🥺")
#custom caption 
